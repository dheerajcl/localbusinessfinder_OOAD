...
public interface BusinessRepository extends JpaRepository<Business, Long> {
    ...
    List<Business> findByCriteriaAndAvailable(
     ...
     List<Business> findByCategoryContainingIgnoreCaseOrNameContainingIgnoreCase(String category, String name);

     Optional<Business> findByBusinessAdmin_Email(String email);
